...
function DevinLoopSlide() {
  const stages = [
    ['Developer request', 'A question needs engineering action', CircleDot, PINK],
    ['Devin automation', 'Uses the relevant playbook', Wrench, TEAL],
    ['Outcome', 'Answer, PR, or human handoff', Check, AMBER],
  ];
  return (
      ...
      <div className="flex h-full flex-col justify-center">
        ...
        <Reveal at={4} className="mx-auto mt-10">
          <div className="flex items-center gap-3 rounded-full border border-[#ffa7c4]/30 bg-[#ffa7c4]/[0.06] px-5 py-3 font-mono text-sm text-[#ffa7c4]">
            <CircleDot className="h-4 w-4" /> new information or a decision → Devin continues
          </div>
        </Reveal>
      </div>
    </SlideShell>
...
export const slides: TalkSlide[] = [
  ...
  { id: 'devin-loop', acts: 4, content: <DevinLoopSlide />, notes: 'This is a simple example of using Devin automation. A question that needs engineering action is paired with the relevant playbook. The outcome may be an answer, a PR, or a handoff to a human. New information and decisions continue the work.' },
